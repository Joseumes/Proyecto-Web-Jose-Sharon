            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item ms-lg-3 mt-2 mt-lg-0">
                        <button class="btn btn-light me-2" type="button" data-bs-toggle="modal" data-bs-target="#reservaModal">
    ...
    <section id="rooms" class="py-5">
        <div class="container py-5">
            <div class="text-center mb-5">
                ...
                <p class="lead text-muted">Todas nuestras habitaciones dobles incluyen:</p>
            </div>
    ...
    <section id="services" class="py-5 bg-light">
        <div class="container py-5">
            <div class="text-center mb-5">
                ...
                <p class="lead text-muted">Disfruta de nuestros servicios adicionales</p>
            </div>
                ...
                <div class="col-md-4">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body text-center p-4">
                            ...
                            <p class="text-muted">Disfruta de nuestros deliciosos platillos en el restaurante del hotel</p>
                            <div class="mt-3">
                ...
                <div class="col-md-4">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body text-center p-4">
                            ...
                            <p class="text-muted">Relájate con nuestros tratamientos especializados</p>
                            <div class="mt-3">
                ...
                <div class="col-md-4">
                    <div class="card h-100 border-0 shadow-sm">
                        <div class="card-body text-center p-4">
                            ...
                            <p class="text-muted">Servicios adicionales para tu comodidad</p>
                            <div class="mt-3">
